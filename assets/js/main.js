const i18n = {
    ar: {
        ...
        about_desc: "شركة متخصصة في توفير الأثاث المكتبي وتجهيز المباني الإدارية الحديثة، مع خبرة في تصميم وتنفيذ المساحات المكتبية بأسلوب عصري وعملي. نقدم حلولاً متكاملة تشمل توريد وتركيب الأثاث المكتبي بكافة أنواعه بما يحقق أفضل استغلال للمساحات. نحرص على تقديم تصاميم تلبي احتياجات بيئة العمل وتعزز الراحة والإنتاجية. نلتزم بالجودة العالية والدقة في التنفيذ وخدمة عملاء احترافية.",
